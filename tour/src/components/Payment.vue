...
<template>
  <div :style="{ 'background-image': 'url(/src/assets/img/10909472.jpg)', 'height': '100vh' }">
    <NavbarUser />
    <div>
      <div class="content">
        <div class="container">
              ...
              <div class="border rounded my-4 my-md-6">
                <div class="row justify-content-center bg-white">
                  ...
                  <div class="col-sm col-lg-6 text-start">
                    ...
                    <input @change="file($event)" ref="file" type="file" class="form-control-file mx-5" id="file"
                      name="file" accept="image/png, image/gif, image/jpeg" required />
